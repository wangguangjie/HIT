...
public class PullListView extends ListView {
    ...
    public void addSharePreference(SharedPreferences p)
    {
        this.preferences=p;
    }
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * 头部
         */
        headView = (RelativeLayout) inflater.inflate(R.layout.application4_pulllist_head, null);
        ...
        text_update=(TextView)headView.findViewById(R.id.updated_at);
         ...
         * 底部
         */
        footView = inflater.inflate(R.layout.application4_pulllist_foot, this, false);
    ...
    private void initAnimation() {
        ...
        reverseAnimation.setDuration(6000);
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            case NONE:
                ...
                ivHeadArrow.setImageResource(R.drawable.ic_refress);
    ...
    public void refreshComplete() {
        preferences.edit().putLong(update+id, System.currentTimeMillis()).commit();
        state = NONE;
        changeHeaderViewByState();
    }
    ...
    private void refreshUpdatedAtValue() {
        lastUpdateTime = preferences.getLong(update + id, -1);
        ...
        text_update.setText(updateAtValue);
    }
    /**
     * 设置没有更多的数据了<br/>
     * 不再显示加载更多按钮
